...
const double ti_points[60][3] =
{
{0.40354860, 0.32647767, 0.85472965},
{0.20177430, -0.00000000, 0.97943302},
{0.40354860, -0.32647767, 0.85472965},
{0.73002627, -0.20177430, 0.65295535},
{0.73002627, 0.20177430, 0.65295535},
{0.85472965, 0.40354860, 0.32647767},
{0.97943302, 0.20177430, -0.00000000},
{0.97943302, -0.20177430, -0.00000000},
{0.85472965, -0.40354860, 0.32647767},
{0.85472965, 0.40354860, -0.32647767},
{0.65295535, 0.73002627, -0.20177430},
{0.65295535, 0.73002627, 0.20177430},
{0.32647767, 0.85472965, 0.40354860},
{0.20177430, 0.65295535, 0.73002627},
{-0.20177430, 0.65295535, 0.73002627},
{-0.40354860, 0.32647767, 0.85472965},
{-0.20177430, 0.00000000, 0.97943302},
{-0.40354860, -0.32647767, 0.85472965},
...
{-0.65295535, 0.73002627, 0.20177430},
{-0.32647767, 0.85472965, 0.40354860},
{-0.00000000, 0.97943302, 0.20177430},
{0.00000000, 0.97943302, -0.20177430},
{0.32647767, 0.85472965, -0.40354860},
{0.20177430, 0.65295535, -0.73002627},
{-0.20177430, 0.65295535, -0.73002627},
...
void CoordinateSystem::RenderFootballPentagons()
{

	for (int p = 0; p < 12; p++)
	{
		const int* pentagon = ti_pentagons[p];
		glBegin(GL_TRIANGLE_FAN);
		for (int i = 0; i < 5; i++)
		{
			glNormal3dv(ti_points[pentagon[i]]);
			glVertex3dv(ti_points[pentagon[i]]);
		}
		glEnd();
	}
}

void CoordinateSystem::RenderFootballHexagons()
{

	for (int p = 0; p < 20; p++)
	{
		const int* hexagon = ti_hexagons[p];
		glBegin(GL_TRIANGLE_FAN);
		for (int i = 0; i < 6; i++)
		{
			glNormal3dv(ti_points[hexagon[i]]);
			glVertex3dv(ti_points[hexagon[i]]);
		}
		glEnd();
	}
}
