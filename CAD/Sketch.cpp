...
public:
	...
	const wchar_t* GetTitle(){return L"Reorder Object";}
...
class PropertySketchOrder : public Property
{
	...
	bool m_done;
public:
	PropertySketchOrder(HeeksObj* object) :Property(object, L"order"){
		m_initial_index = 0;
		m_done = false;
...
void CSketch::GetProperties(std::list<Property *> *list)
{
	...
	list->push_back(new PropertyInt(this, L"Number of elements", (const int*)&num_children_for_properties));
...
public:
	...
	std::wstring BitmapPath(){return _T("la2face");}
};
...
HeeksObj *CSketch::Parallel( const double distance )
{
    try {
			...
			// wxMessageBox(std::wstring(_("Error making offset")) + _T(": ") + Ctt(e->GetMessageString()));
			return(NULL);
		}
...
public:
	void Run()
	{
	    std::wstring message(_("Use negative for smaller and Positive for larger)"));
	    std::wstring prompt(_("Enter the distance"));
	    std::wstring caption(_("Distance"));
		...
		if(theApp->InputDouble(std::wstring(_("Use negative for smaller and Positive for larger)") ), _("Enter the distance"), distance))
		{
			...
			{
				wxMessageBox(std::wstring(_("Error making offset")));
			}
		}
	}
	const wchar_t* GetTitle(){return _("Copy Parallel");}
	std::wstring BitmapPath(){return _T("la2face");}
};
...
public:
	...
	std::wstring BitmapPath(){return _T("splitarcs");}
};
...
public:
	...
	const wchar_t* GetTitle(){return _("Click midpoint");}
	std::wstring BitmapPath(){return _T("click_sketch_midpoint");}
};
...
public:
	...
	const wchar_t* GetTitle(){return _("Click centre-top point");}
	std::wstring BitmapPath(){return _T("click_sketch_centre_top");}
};
...
public:
	...
	const wchar_t* GetTitle(){return _("Click centre-bottom point");}
	std::wstring BitmapPath(){return _T("click_sketch_centre_bottom");}
};
...
public:
	...
	const wchar_t* GetTitle(){return _("Click centre-right point");}
	std::wstring BitmapPath(){return _T("click_sketch_centre_right");}
};
...
public:
	...
	const wchar_t* GetTitle(){return _("Click centre-left point");}
	std::wstring BitmapPath(){return _T("click_sketch_centre_left");}
};
